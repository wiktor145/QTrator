...
cx q[16],q[19];
cx q[19],q[22];
barrier q[1],q[8],q[23],q[4],q[9],q[11],q[3],q[17],q[24],q[25],q[22],q[16],q[19],q[13],q[2],q[6],q[5],q[0],q[18],q[26],q[20],q[7],q[12],q[14],q[10],q[15],q[21];
measure q[1] -> meas[0];
measure q[24] -> meas[1];
measure q[18] -> meas[2];
measure q[0] -> meas[3];
