...
cx q[12],q[10];
u(1.8755996,-2.8418239,-2.0530498) q[10];
u(1.2671654,-2.8411808,-2.6595318) q[12];
...
cx q[14],q[13];
u(1.8755996,-2.8418239,-2.0530498) q[13];
cx q[13],q[12];
u(1.8744272,0.30041185,-0.48206086) q[14];
cx q[14],q[13];
cx q[13],q[14];
cx q[14],q[13];
u2(pi/2,-pi) q[15];
...
cx q[10],q[12];
cx q[12],q[10];
u(1.650625,2.7239073,7.5902742) q[10];
...
cx q[22],q[25];
u(1.2671654,0.30041185,-2.6595318) q[22];
cx q[22],q[19];
cx q[19],q[22];
cx q[19],q[16];
cx q[16],q[19];
...
u(1.8755996,0.29976872,-2.0530498) q[25];
cx q[25],q[24];
cx q[24],q[25];
cx q[24],q[23];
cx q[23],q[24];
...
cx q[21],q[18];
u(1.2579606,-1.5721871,-3.1411646) q[18];
u(pi/10,-pi/2,pi/2) q[21];
cx q[21],q[18];
u(1.569473,1.569473,-pi) q[18];
u(pi/10,-pi,pi/2) q[21];
cx q[21],q[18];
u(1.3934085,-0.11514017,-0.096864527) q[18];
cx q[15],q[18];
cx q[18],q[15];
cx q[15],q[18];
cx q[12],q[15];
cx q[15],q[12];
cx q[12],q[15];
u(2.4969192,0.20960201,-1.3106836) q[12];
cx q[12],q[10];
u(1.5720872,0.024475914,-1.5694734) q[10];
u(pi,0.84252689,2.4133232) q[12];
cx q[12],q[10];
u(1.545556,-0.15564289,-4.4142237) q[10];
u(0.95118037,-1.7618027,-1.4589741) q[12];
cx q[13],q[12];
cx q[12],q[13];
cx q[13],q[12];
cx q[13],q[14];
cx q[14],q[13];
cx q[14],q[16];
u(2.4969192,0.20960201,-1.3106836) q[15];
cx q[16],q[14];
u(1.9425497,0.00051592826,-1.569376) q[16];
u(2.9718702,0.0077218815,1.5786308) q[18];
cx q[15],q[18];
u(pi,0.84252689,2.4133232) q[15];
u(1.5720872,0.024475914,-1.5694734) q[18];
cx q[15],q[18];
u(0.95118037,-1.7618027,-1.4589741) q[15];
cx q[12],q[15];
cx q[15],q[12];
cx q[12],q[15];
u2(-0.07777063,0) q[12];
cx q[12],q[10];
u(1.5720872,0.024475914,-1.5694734) q[10];
u(pi,0.84252689,2.4133232) q[12];
cx q[12],q[10];
u(1.7488136,1.0378608,1.1286871) q[10];
u(2.5888658,1.9734881,1.7954307) q[12];
u2(-0.07777063,0) q[15];
u(1.5462411,-0.15644392,-3.5950738) q[18];
cx q[15],q[18];
u(pi,0.84252689,2.4133232) q[15];
u(1.5720872,0.024475914,-1.5694734) q[18];
cx q[15],q[18];
u(2.5888658,1.9734881,1.7954307) q[15];
cx q[12],q[15];
cx q[15],q[12];
cx q[12],q[15];
cx q[12],q[13];
...
u(0.84973678,1.293321,1.0829437) q[21];
cx q[21],q[23];
cx q[23],q[21];
cx q[23],q[24];
cx q[24],q[23];
...
u(1.569473,1.569473,-pi) q[25];
cx q[22],q[25];
u(0.88919579,2.1951998,1.1446289) q[22];
cx q[19],q[22];
cx q[22],q[19];
cx q[19],q[22];
u(0.64467349,2.9319906,1.830909) q[19];
cx q[19],q[16];
u(1.5720872,0.024475914,-1.5694734) q[16];
u(pi,0.84252689,2.4133232) q[19];
cx q[19],q[16];
u(0.55190167,-1.1700763,2.4691126) q[16];
cx q[16],q[14];
cx q[14],q[16];
cx q[14],q[13];
cx q[13],q[14];
...
u(1.391583,-2.1043072,-2.6993812) q[19];
u(0.64467349,2.9319906,1.830909) q[22];
u(2.5087136,-0.35074056,-0.44465325) q[25];
cx q[22],q[25];
...
u(pi/10,-pi,pi/2) q[16];
cx q[16],q[14];
u(2.1131129,2.9956134,1.3725943) q[14];
cx q[14],q[13];
cx q[13],q[14];
cx q[14],q[13];
u2(pi/2,0) q[13];
...
u(1.0271823,2.995309,0.19835931) q[16];
cx q[16],q[19];
cx q[19],q[16];
cx q[14],q[16];
cx q[16],q[14];
...
u(pi/2,pi/2,0) q[22];
u(2.5891736,2.7388957,5.6083832) q[25];
cx q[22],q[25];
u(pi/10,-pi/2,pi/2) q[22];
u(1.2579606,-1.5721871,-3.1411646) q[25];
cx q[22],q[25];
...
u(pi/10,-pi,pi/2) q[19];
cx q[19],q[16];
u(1.7769916,3.0957933,2.2443402) q[16];
u(1.3635669,-0.044955891,-0.67371699) q[19];
u(pi/2,pi/2,0) q[22];
...
barrier q[23],q[24],q[19],q[6],q[0],q[8],q[3],q[25],q[15],q[18],q[12],q[17],q[22],q[5],q[20],q[26],q[13],q[7],q[4],q[16],q[11],q[21],q[1],q[9],q[2],q[10],q[14];
measure q[19] -> ans[0];
measure q[25] -> ans[1];
measure q[22] -> ans[2];
measure q[13] -> ans[3];
