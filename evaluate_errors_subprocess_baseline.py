...
try:
    ...
    with open("benchmark_errors_results.csv", "a") as f:
        ...
        f.write(str(state_fidelity(result_ideal, result_ideal)) + SEPARATOR)
        f.write(str(state_fidelity(result_ideal, result_noise)) + SEPARATOR)
        f.write(str(state_fidelity(result_noise, result_noise)))
        f.write("\n")
