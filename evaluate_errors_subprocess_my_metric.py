...
try:
    ...
    fidelity_ideal[(method, circuit)] = hellinger_fidelity(result_ideal, results_curr_ideal)
    fidelity_noise[(method, circuit)] = hellinger_fidelity(result_ideal, results_curr)
    fidelity_noise_noise[(method, circuit)] = hellinger_fidelity(result_noise, results_curr)
    ...
    print("Hellinger Fidelity ideal ideal -", fidelity_ideal[(method, circuit)])
    print("Hellinger Fidelity ideal noise -", fidelity_noise[(method, circuit)])
    print("Hellinger Fidelity noise noise -", fidelity_noise_noise[(method, circuit)])
    print()
    print("$$$$$$$$$$$$")
